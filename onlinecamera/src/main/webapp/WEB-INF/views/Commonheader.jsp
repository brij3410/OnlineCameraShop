...
<nav class="navbar navbar-inverse">
  ...
  <div class="collapse navbar-collapse " id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="Addproduct">Add Product</a></li><br/>
      </ul>
      <ul class="nav navbar-nav navbar-right">
      	<li><a href="Logout"> Logout</a></li>
        <li><a href="#"><span class="glyphicon glyphicon-user"></span> Your Account</a></li>
        <li><a href="mycart"><span class="glyphicon glyphicon-shopping-cart"></span> Cart(${cartSize})</a></li><br/>
        <li><a href="#"><h5>Hi,${user.firstName} ${success} ${loginuser.firstName} ${logoutmsg}</h5></a></li>
      </ul>
    </div>
  </div>
</nav>
